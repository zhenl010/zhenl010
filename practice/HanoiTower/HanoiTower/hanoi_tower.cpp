...
HanoiTower::HanoiTower(int level)
...
void HanoiTower::RecursiveMoveTo(HANOI_TOWER_ENUM desti)
{
    RecursiveMoveTo(level_, current_, desti, MiddleTower(current_, desti));
    current_ = desti;
}

void HanoiTower::IterativeMoveTo(HANOI_TOWER_ENUM desti)
{
    if (level_ <= 0)
    {
...
inline HanoiTower::HANOI_TOWER_ENUM HanoiTower::MiddleTower(HANOI_TOWER_ENUM origin, HANOI_TOWER_ENUM desti)
{
    return static_cast<HANOI_TOWER_ENUM>(TOWER_NUM-(current_+desti));
}

void HanoiTower::OneLegalMove(HANOI_TOWER_ENUM origin, HANOI_TOWER_ENUM desti)
{
    using namespace std;
...
void HanoiTower::RecursiveMoveTo(int level, HANOI_TOWER_ENUM origin, HANOI_TOWER_ENUM desti, HANOI_TOWER_ENUM middle)
{
    if (level==0)
    {
        return;
...
/// @TODO:
void HanoiTower::IterativeMove(HANOI_TOWER_ENUM origin, HANOI_TOWER_ENUM desti, HANOI_TOWER_ENUM middle)
{
...
void HanoiTower::FindNextLegalMove(HANOI_TOWER_ENUM& next_from, HANOI_TOWER_ENUM& next_to,
