...
namespace Pathfinding {
	[System.Serializable]
	/** Stores the navgraphs for the A* Pathfinding System. An instance of this class is assigned to AstarPath::astarData, from it you can access all graphs loaded through #graphs.\n This class also handles a lot of the high level serialization. */
