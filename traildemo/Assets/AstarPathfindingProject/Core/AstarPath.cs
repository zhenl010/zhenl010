...
public class AstarPath : MonoBehaviour {
	...
	public static System.Version Version {
		get {
			return new System.Version (3,0,8);
		}
	}
	...
	/** The amount of logging. Use less logging to improve performance (a bit) or just to get rid of the Console spamming, use more logging (heavy) if you want more information about what the pathfinding is doing. InGame will display the latest path log using in game GUI. */
...
#line default
	...
	*/
	...
	public void Awake () {
		...
		/*AstarProfiler.InitializeFastProfile (new string [12] {
			"Prepare", 			//0
			"Initialize",		//1
			"CalculateStep",	//2
			"Trace",			//3
