...
//////////////////////////////////////////////////////////////////////////
#ifndef ADAM_TREE_SET_H_
#define ADAM_TREE_SET_H_

#include "adam_tree_node.h"
...
private:
    ...
    AdamTreeSet(const AdamTreeSet&);
    AdamTreeSet& operator=(const AdamTreeSet&);
...
template <typename KeyType>
AdamTreeSet<KeyType>::AdamTreeSet()
{
    root_ = NULL;
}
...
template <typename KeyType>
bool AdamTreeSet<KeyType>::Insert( KeyType key )
{
    return InsertTo(key, root_);
}

template <typename KeyType>
bool AdamTreeSet<KeyType>::Contains( KeyType key ) const
{
...
template <typename KeyType>
bool AdamTreeSet<KeyType>::GetNthItm( size_type n, KeyType& key ) const
{
    AugTreeNode<KeyType, size_type>* node = root_;
...
template <typename KeyType>
bool AdamTreeSet<KeyType>::Remove( KeyType key )
{
    return RemoveFrom(key, root_);
}

template <typename KeyType>
bool AdamTreeSet<KeyType>::IsEmpty() const
{
    return root_ == NULL;
}

template <typename KeyType>
typename AdamTreeSet<KeyType>::size_type AdamTreeSet<KeyType>::Size() const
{
    return root_->num_;
}

template <typename KeyType>
void AdamTreeSet<KeyType>::Clear()
{
...
template <typename KeyType>
bool AdamTreeSet<KeyType>::IsBalanced( AugTreeNode<KeyType, size_type>* smallSubTree
...
template <typename KeyType>
bool AdamTreeSet<KeyType>::DoSingle( AugTreeNode<KeyType, size_type>* subTreeX
...
template <typename KeyType>
bool AdamTreeSet<KeyType>::InsertTo(KeyType key, AugTreeNode<KeyType, size_type>* &node)
{
    if (node == NULL)
    {
...
template <typename KeyType>
bool AdamTreeSet<KeyType>::RemoveFrom(KeyType key, AugTreeNode<KeyType, size_type>* &node)
{
    if (node == NULL)
    {
        // nothing to do ...
...
template <typename KeyType>
void AdamTreeSet<KeyType>::RebalanceAt(AugTreeNode<KeyType, size_type>* &node)
{
    // It's caller's responsibility to make sure node is not NULL
    if (node->num_ > 2)
    {
...
template <typename KeyType>
void AdamTreeSet<KeyType>::LeftRotateOne(AugTreeNode<KeyType, size_type>* &node)
{
...
template <typename KeyType>
void AdamTreeSet<KeyType>::LeftRotateTwo(AugTreeNode<KeyType, size_type>* &node)
{
    AugTreeNode<KeyType, size_type>* nodeN = node->leftChild_;
    AugTreeNode<KeyType, size_type>* nodeM = node->rightChild_;
    AugTreeNode<KeyType, size_type>* nodeX = nodeM->leftChild_;
...
template <typename KeyType>
void AdamTreeSet<KeyType>::RightRotateOne(AugTreeNode<KeyType, size_type>* &node)
{
...
template <typename KeyType>
void AdamTreeSet<KeyType>::RightRotateTwo(AugTreeNode<KeyType, size_type>* &node)
{
    AugTreeNode<KeyType, size_type>* nodeN = node->rightChild_;
    AugTreeNode<KeyType, size_type>* nodeM = node->leftChild_;
    AugTreeNode<KeyType, size_type>* nodeX = nodeM->rightChild_;
...
template <typename KeyType>
void AdamTreeSet<KeyType>::ClearAll(AugTreeNode<KeyType, size_type>* node)
{
    if (node == NULL)
    {
        // done
